...
namespace Tuna\BannerSlider\Block\Adminhtml\Banner\Widget;
...
class Chooser extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Tuna\BannerSlider\Model\ResourceModel\Banner\CollectionFactory $collectionFactory,
        array $data = []
    ) {
    ...
    public function prepareElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $sourceUrl = $this->getUrl('bannerslideradmin/block_widget/chooser', ['uniq_id' => $uniqId]);
    ...
    {
        return $this->getUrl('bannerslideradmin/block_widget/chooser', ['_current' => true]);
    }
}
