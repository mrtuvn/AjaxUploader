...
use Tuna\BannerSlider\Model\Status as Status;
...
class Form extends Generic implements TabInterface
{
    ...
    {
        $slider = $this->_coreRegistry->registry('slider'); //get registry from controller registered
        ...
        $form->setHtmlIdPrefix('slider_'); //set id prefix for form
        ...
        $fieldMaps['sort_type'] = $fieldset->addField(
            ...
            [
                ...
                'values' => [
                    [
                        'value' => \Tuna\BannerSlider\Model\Slider::SORT_TYPE_RANDOM,
                        'label' => __('Random')
                    ],
                    [
                        'value' => \Tuna\BannerSlider\Model\Slider::SORT_TYPE_ORDERLY,
                        'label' => __('Orderly')
                    ]
                ]
            ]
